...
class GUI:
    ...
    def insert_info(self, l_string, rules_list, rotate, number_of_iteration, line_length, start_point):
        ...
        for line in rules_list:
            print(line)
            self.text_rules.insert("%s.0" % (rules_list.index(line)), "#%s\n" % (line))
    ...
    def activate_widget(self, root):
        ...
        Tk.Button(frame2, text="Save your L-System as .json", command=lambda: self.get_variable("Save")).pack()
        ...
        label_frame_2 = Tk.LabelFrame(root, text="Load an L-System from a .json file :")
