...
class GUI:
    ...
    def activate_widget(self, root):
        ...
        Tk.Button(frame2, text="Save your L-System as .ls", command=lambda: self.get_variable("Save")).pack()
        ...
        label_frame_2 = Tk.LabelFrame(root, text="Load an L-System from a .ls file :")
