...
class GUI:
    ...
    def activate_widget(self, root):
        ...
        Tk.Button(label_frame, text="Save your L-System", command=lambda: self.get_variable("Save")).pack()
        
        Tk.Button(label_frame, text="Draw", command=lambda: self.get_variable("Draw")).pack()
        
        label_frame.pack(padx=10, pady=10)
        
        label_frame_2 = Tk.LabelFrame(root, text="Load an L-System from a .txt file :")
